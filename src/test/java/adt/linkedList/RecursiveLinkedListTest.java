...
public class RecursiveLinkedListTest {
	...
	public void init() {
		...
		this.lista1 = new RecursiveSingleLinkedListImpl<Integer>();
		this.lista2 = new RecursiveSingleLinkedListImpl<Integer>();
		this.lista3 = new RecursiveSingleLinkedListImpl<Integer>();
		this.lista4 = new RecursiveSingleLinkedListImpl<Integer>();
