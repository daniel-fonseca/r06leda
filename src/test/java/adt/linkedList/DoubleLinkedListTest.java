...
public class DoubleLinkedListTest {
	...
	public void init() {
		...
		this.lista1 = new DoubleLinkedListImpl<Integer>();
		this.lista2 = new DoubleLinkedListImpl<Integer>();
		this.lista3 = new DoubleLinkedListImpl<Integer>();
		this.lista4 = new DoubleLinkedListImpl<Integer>();
